...
I used was the given cleaned data with stemmed words to do the project. First I want to take a look at the overall frequency of words in lyrics.
...
Now let's look at the plots from another angle, for Hip-Hop and Pop, the proportion of "day" and "night" both went down around 2000. For Rock, both were going up. For Metal, the proportion change of words "day" and "night" are different around 2000. Only Metal is different! So an important reason of the different direction of change in "day" and "night" is, the genre Metal led the difference.
